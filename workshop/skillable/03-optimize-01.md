...
1. [] Open the agent's source file `zava/src/zava-travel-concierge/main.py` and
   skim it. This is the agent you've been observing — and the code the optimize
   loop will change.

![The Codespace in VS Code with the zava-travel-concierge main.py open](https://raw.githubusercontent.com/microsoft/Build26-LAB540-observe-optimize-and-protect-your-hosted-agents-in-microsoft-foundry/aiewf26-refresh/workshop/self-guided/images/03-optimize-01-codespace.png)

>[!Alert] **Reset to a clean baseline.** Clear any stale `.foundry` state and
> restore the baseline concierge prompt so this run starts from the same
> intentionally under-optimized prompt as everyone else:
>
